...
echo '<div id="specials" style="display:none;"><ul>';
if (isadmin()) {
	echo '<li><a href="#" onClick="window.opener.setContact(\'[allsite]\')">'.get_string('allsite','internalmail').'</a><br>';
}
if (isteacher($course->id)) {
	echo '<li><a href="#" onClick="window.opener.setContact(\'[allcourse]\')">'.get_string('allcourse','internalmail').'</a><br>';
	echo '<li><a href="#" onClick="window.opener.setContact(\'[allstudents]\')">'.get_string('allstudents','internalmail').'</a><br>';
}
echo '<li><a href="#" onClick="window.opener.setContact(\'[allteachers]\')">'.get_string('allteachers','internalmail').'</a><br>';
...
echo '<form method="POST" action="search.php?id='.$cm->id.'&pop=si" target="bssearch">' .
		'<input id="sfield" type="text" name="search" />' .
