...
class block_calendar_month extends block_base {
    ...
    function get_content() {
        ...
        require_once($CFG->dirroot.'/mod/Internalmail/blocks/calendar_month/lib.php');
        ...
        if ($courseshown == SITEID) {
            ...
            $this->content->text .= calendar_top_controls2('frontpage', array('m' => $_GET['cal_m'], 'y' => $_GET['cal_y']));
            ...
            $this->content->text .= calendar_overlib_html();
            $this->content->text .= calendar_top_controls2('course', array('id' => $courseshown, 'm' => $_GET['cal_m'], 'y' => $_GET['cal_y']));
            $this->content->text .= calendar_get_mini($courses, $group, $user, $_GET['cal_m'], $_GET['cal_y']);
